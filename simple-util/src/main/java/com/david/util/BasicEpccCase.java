...
import com.david.util.constants.DrctnCd;
...
public class BasicEpccCase {
	...
	public static final String ORI_ISSR_ID = "OriIssrId";
	public static final String MSG_TP = "MsgTp";
	...
	// api
	public static final String EPCC_401_001_01 = "epcc.401.001.01";
	public static final String EPCC_101_001_01 = "epcc.101.001.01";
	public static final String EPCC_103_001_01 = "epcc.103.001.01";
	public static final String EPCC_104_001_01 = "epcc.104.001.01";
	...
	public static MsgHeader getMsgHeader(String msgTp, String ncrptnSN, String dgtlEnvlpStr) {
		...
		msgHeader.setDrctn(DrctnCd.PAYMENT_INSTITUTION_TO_EPCC);
		msgHeader.setSignSN(MSG_HEADER_SIGN_SN);
	...
	protected <T> String postToEpccGateway(String url, String api, T request) throws Exception {
		...
		headerMap.put(CONNECTION, KEEP_ALIVE);

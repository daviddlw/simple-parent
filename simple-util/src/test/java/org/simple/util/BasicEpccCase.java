...
public class BasicEpccCase {
	...
	// protected static final String EPCC_PROT_551_URL =
	// "https://59.151.65.97:551/preSvr";
	...
	protected static String certPath = "D:" + File.separator + "epcc" + File.separator + "wanglian-rsa.cer";
	// 四要素
